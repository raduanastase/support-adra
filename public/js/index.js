...
module.exports = HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<h1>Adaugare caz</h1>\n<button class=\"close-button\" data-close aria-label=\"Close modal\" type=\"button\">\n    <span aria-hidden=\"true\">&times;</span>\n</button>\n\n<form id=\"add-case-form\" method=\"post\" action=\"api/posts\" data-abide novalidate enctype=\"multipart/form-data\"> \n    <input type=\"hidden\" name=\"_token\" value=\""
    + container.escapeExpression(((helper = (helper = helpers.csrfToken || (depth0 != null ? depth0.csrfToken : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(alias1,{"name":"csrfToken","hash":{},"data":data,"blockParams":blockParams}) : helper)))
    + "\">\n\n    <div data-abide-error class=\"alert callout\" style=\"display: none;\">\n        <p><i class=\"fi-alert\"></i> Unele campuri obligatorii sunt necompletate.</p>\n    </div>\n\n    <div class=\"row\">\n        <div class=\"small-12 columns upload-images\">\n            <label for=\"image-upload-input\">\n                <input type=\"file\" id=\"image-upload-input\" name=\"files[]\" multiple accept=\"image/*\">\n                <span class=\"button\" id=\"image-upload-button\">Adauga poze</span>\n            </label>\n            <ul class=\"files-list\">\n\n            </ul>\n        </div>\n    </div>\n\n    <div class=\"row\">\n        <div class=\"small-12 columns section-title\">\n            <label for=\"title\">Numele cazului\n                <small>*</small>\n                <input type=\"text\" name=\"title\" id=\"title\" required>\n                <span class=\"form-error\">Completarea campului este obligatorie</span>\n            </label>\n        </div>\n    </div>\n\n    <div class=\"row\">\n        <div class=\"small-12 columns section-title\">\n            Date de contact ale pesoanei care raporteaza\n        </div>\n    </div>\n\n    <div class=\"row\">\n        <div class=\"small-6 columns\">\n            <label for=\"reporter-last-name\">Numele\n                <small>*</small>\n                <input type=\"text\" name=\"reporter_last_name\" id=\"reporter-last-name\" required>\n                <span class=\"form-error\">Completarea campului este obligatorie</span>\n            </label>\n        </div>\n        <div class=\"small-6 columns\">\n            <label for=\"reporter-first-name\">Prenumele\n                <small>*</small>\n                <input type=\"text\" name=\"reporter_first_name\" id=\"reporter-first-name\" required>\n                <span class=\"form-error\">Completarea campului este obligatorie</span>\n            </label>\n        </div>\n    </div>\n\n    <div class=\"row\">\n        <div class=\"small-12 medium-4 columns\">\n            <label for=\"reporter-cnp\">C.N.P.\n                <input type=\"text\" name=\"reporter_cnp\" id=\"reporter_cnp\">\n            </label>\n        </div>\n        <div class=\"small-12 medium-4 columns\">\n            <label for=\"reporter-ci-series\">C.I. Seria\n                <input type=\"text\" name=\"reporter_ci_series\" id=\"reporter-ci-series\">\n            </label>\n        </div>\n        <div class=\"small-12 medium-4 columns\">\n            <label for=\"reporter-ci-number\">C.I. Numar\n                <input type=\"text\" name=\"reporter_ci_number\" id=\"reporter-ci-number\">\n            </label>\n        </div>\n    </div>\n\n    <div class=\"row\">\n        <div class=\"small-12 columns\">\n            <label for=\"reporter-phone\">Numar de telefon\n                <small>*</small>\n                <input type=\"tel\" name=\"reporter_phone\" id=\"reporter_phone\" required pattern=\"number\">\n                <span class=\"form-error\">Completarea campului este obligatorie si trebuie sa fie numai cifre!</span>\n            </label>\n        </div>\n    </div>\n\n    <div class=\"row\">\n        <div class=\"small-12 columns\">\n            <label for=\"reporter-email\">Email\n                <input type=\"email\" name=\"reporter_email\" id=\"reporter_email\">\n            </label>\n        </div>\n    </div>\n\n    <div class=\"row\">\n        <div class=\"small-12 columns section-title\">\n            Date despre persoana in cauza\n        </div>\n    </div>\n\n    <div class=\"row\">\n        <div class=\"small-6 columns\">\n            <label for=\"person-last-name\">Numele <b>persoanei in cauza</b>\n                <small>*</small>\n                <input type=\"text\" name=\"person_last_name\" id=\"person-last-name\" required>\n                <span class=\"form-error\">Completarea campului este obligatorie</span>\n            </label>\n        </div>\n        <div class=\"small-6 columns\">\n            <label for=\"person-first-name\">Prenumele <b>persoanei in cauza</b>\n                <small>*</small>\n                <input type=\"text\" name=\"person_first_name\" id=\"person-first-name\" required>\n                <span class=\"form-error\">Completarea campului este obligatorie</span>\n            </label>\n        </div>\n    </div>\n\n    <div class=\"row\">\n        <div class=\"small-12 medium-4 columns\">\n            <label for=\"person-cnp\">C.N.P.\n                <input type=\"text\" name=\"person_cnp\" id=\"person_cnp\">\n            </label>\n        </div>\n        <div class=\"small-12 medium-4 columns\">\n            <label for=\"person-ci-series\">C.I. Seria\n                <input type=\"text\" name=\"person_ci_series\" id=\"person-ci-series\">\n            </label>\n        </div>\n        <div class=\"small-12 medium-4 columns\">\n            <label for=\"person-ci-number\">C.I. Numar\n                <input type=\"text\" name=\"person_ci_number\" id=\"person-ci-number\">\n            </label>\n        </div>\n    </div>\n\n    <div class=\"row\">\n        <div class=\"small-12 medium-6 columns\">\n            <label for=\"person-county-id\">Judet\n                <small>*</small>\n                <select name=\"person_county_id\" id=\"person-county-id\" required>\n                    <option value=\"\">Alege</option>\n"
    ...
    + "\n    <div class=\"row\">\n        <div class=\"small-6 columns\">\n            <button id=\"submit-button\" class=\"button float-right\" value=\"Submit\">Submit</button>\n        </div>\n        <div class=\"small-6 columns\">\n            <button class=\"button\" type=\"reset\" value=\"Reset\">Reset</button>\n        </div>\n    </div>\n</form>";
...
var SIZE_LIMIT = 3145728; //3 MegaBytes
var NR_OF_ATTACHMENTS = 5;
...
},{"./AddPostView.hbs":27,"backbone":1,"jquery":22,"underscore":23}],29:[function(require,module,exports){
"use strict";
...
},{"../utils/LoadingCover":49,"./PostView.hbs":30,"./PostView/EditPostView":33,"./PostView/ReadPostView":38,"backbone":1}],32:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<h1>Editare caz</h1>\n<button class=\"close-button\" data-close aria-label=\"Close modal\" type=\"button\">\n    <span aria-hidden=\"true\">&times;</span>\n</button>\n\n<form id=\"edit-post\" data-abide novalidate>\n    <div class=\"row\">\n        <div class=\"small-12 columns current-images\">\n        </div>\n    </div>\n\n    <div class=\"row\">\n        <div class=\"small-12 columns upload-images\">\n            <label for=\"image-upload-input\">\n                <input type=\"file\" id=\"image-upload-input\" multiple accept=\"image/*\">\n                <span class=\"button\" id=\"image-upload-button\">Adauga poze</span>\n            </label>\n            <ul class=\"files-list\">\n\n            </ul>\n        </div>\n    </div>\n\n    <div class=\"row\">\n        <div class=\"small-12 columns section-title\">\n            <label for=\"case-name\">Numele cazului\n                <input type=\"text\" name=\"title\" id=\"title\" value=\""
    ...
    + "\">\n            </label>\n        </div>\n    </div>\n\n    <div class=\"row\">\n        <div class=\"small-12 columns\">\n            <label for=\"reporter-phone\">Numar de telefon\n                <input type=\"tel\" name=\"reporter-phone\" id=\"reporter-phone\" pattern=\"number\" value=\""
    ...
    + "\">\n            </label>\n        </div>\n    </div>\n\n    <div class=\"row\">\n        <div class=\"small-12 columns section-title\">\n            Date despre persoana in cauza\n        </div>\n    </div>\n\n    <div class=\"row\">\n        <div class=\"small-6 columns\">\n            <label for=\"person-last-name\">Numele <b>persoanei in cauza</b>\n                <input type=\"text\" name=\"person-last-name\" id=\"person-last-name\" value=\""
    ...
    + "\">\n            </label>\n        </div>\n        <div class=\"small-6 columns\">\n            <label for=\"person-first-name\">Prenumele <b>persoanei in cauza</b>\n                <input type=\"text\" name=\"person-first-name\" id=\"person-first-name\" value=\""
    ...
    + "\">\n            </label>\n        </div>\n    </div>\n\n    <div class=\"row\">\n        <div class=\"small-12 medium-4 columns\">\n            <label for=\"person-cnp\">C.N.P.\n                <input type=\"text\" name=\"person-cnp\" id=\"person-cnp\" value=\""
    ...
    + "\">\n            </label>\n        </div>\n        <div class=\"small-12 medium-4 columns\">\n            <label for=\"person-ci-series\">C.I. Seria\n                <input type=\"text\" name=\"person-ci-series\" id=\"person-ci-series\" value=\""
    ...
    + "\">\n            </label>\n        </div>\n        <div class=\"small-12 medium-4 columns\">\n            <label for=\"person-ci-number\">C.I. Numar\n                <input type=\"text\" name=\"person-ci-number\" id=\"person-ci-number\" value=\""
    ...
    + "                </select>\n            </label>\n        </div>\n        <div class=\"small-12 medium-6 columns\">\n            <label for=\"person-city\">Localitate\n                <input type=\"text\" name=\"person-city\" id=\"person-city\" value=\""
    ...
    + "\">\n            </label>\n        </div>\n    </div>\n\n    <div class=\"row\">\n        <div class=\"small-12 columns\">\n            <label for=\"person-address\">Alte detalii adresa (strada,numar,etc.)\n                <input type=\"text\" name=\"person-address\" id=\"person-address\" value=\""
    ...
    + "\">\n            </label>\n        </div>\n    </div>\n\n    <div class=\"row\">\n        <div class=\"small-12 columns\">\n            <label for=\"person-description\">Descriere\n                <textarea type=\"text\" name=\"person-description\" id=\"person-description\" maxlength=\"1000\" value=\""
    ...
    + "\"></textarea>\n            </label>\n        </div>\n    </div>\n\n    <div class=\"row\">\n        <div class=\"small-12 medium-6 columns\">\n            <label for=\"person-money-total\">\n                        <span class=\"row\">\n                            <span class=\"small-12 columns\">Suma necesara</span>\n                        </span>\n                        <span class=\"row\">\n                            <span class=\"small-10 columns\"><input type=\"text\" name=\"person-money-total\" id=\"person-money-total\" value=\""
...
module.exports = HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "                    <option value=\""
    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
    + "\" "
    + alias4((helpers.sif || (depth0 && depth0.sif) || alias2).call(alias1,(helpers.eq || (depth0 && depth0.eq) || alias2).call(alias1,(depth0 != null ? depth0.id : depth0),(depth0 != null ? depth0.person_county_id : depth0),{"name":"eq","hash":{},"data":data}),"selected=\"selected\"","",{"name":"sif","hash":{},"data":data}))
    + ">"
    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
    + "</option>\n";
},"5":function(container,depth0,helpers,partials,data) {
...
var /*$ = global.$ = global.jQuery = require('jquery'),*/
Backbone = require('backbone'),
    template = require("./PaginationView.hbs");
Backbone.$ = $;
